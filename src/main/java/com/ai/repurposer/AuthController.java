...
public class AuthController {
    ...
    public AuthController(UserStore userStore, Passwords passwords) {
    ...
    @PostMapping("/upgrade")
    public ResponseEntity<String> upgrade(@RequestParam String email, @RequestParam(defaultValue = "pro") String plan) {
        String normalizedEmail = normalizeEmail(email);
    ...
    private static String normalizePaidPlan(String plan) {
        String normalized = normalizePlan(plan);
        return "free".equals(normalized) ? "pro" : normalized;
    }
}
