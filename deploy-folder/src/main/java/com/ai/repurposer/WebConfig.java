...
public class WebConfig implements WebMvcConfigurer {
    ...
    public WebConfig(
        ...
        @Value("${app.cors.allowed-origins:http://localhost:3000,http://localhost:5173,https://*.vercel.app,https://*.netlify.app,https://ai-repurposer.netlify.app,https://attractive-youth-production-c125.up.railway.app}") String origins,
        @Value("${app.cors.allowed-methods:GET,POST,OPTIONS}") String methods,
        @Value("${app.cors.allowed-headers:Content-Type,Authorization,X-Auth-Token,X-Admin-Key}") String headers
    ) {
