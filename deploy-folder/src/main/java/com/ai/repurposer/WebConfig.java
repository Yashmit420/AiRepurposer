...
public class WebConfig implements WebMvcConfigurer {
    ...
    public WebConfig(
        ...
        @Value("${app.cors.allowed-origins:http://localhost:3000,http://localhost:5173,https://*.vercel.app,https://attractive-youth-production-c125.up.railway.app}") String origins,
